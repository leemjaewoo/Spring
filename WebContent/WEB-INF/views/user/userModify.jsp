...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css">
  ...
  <body>
      ...
      <div class="row">
          ...
          <form id="frm" action="${cp }/user/usermodifyformcontroller"
			...
			<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-9">
							<button id="edtBtn" type="button" class="btn btn-default">사용자 수정완료</button>
						</div>
					</div>
				</form>
...
<script>
	...
	function initData() {
		...
		$("img").attr("src","${cp}/user/profileImg?userId=${param.userId}");
